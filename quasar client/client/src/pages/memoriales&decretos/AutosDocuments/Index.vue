...
export default {
  ...
  methods: {
    ...
    ...mapActions("memorials_decrets", ["GetMemorialsFromApiAutos","FindDataFromAutosDocs","OpenDialogDelete"]),
    GetPressEnter(e){
      //TODO BUSCADOR
       if (e.keyCode === 13) {
         let querys = {
          ...
          this.FindDataFromAutosDocs(querys)
    ...
    nextPage: async function() {
       ...
       if(this.isSearching == false){
        let params;
          ...
          this.GetMemorialsFromApiAutos(params)
          .then(response =>{            
        ...
        if (this.data_per_page >= this.memorials_list_searching.length) {
          ...
          this.FindDataFromAutosDocs(params);
