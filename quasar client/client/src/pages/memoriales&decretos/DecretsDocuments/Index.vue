...
export default {
  ...
  methods: {
    ...
    ...mapActions("memorials_decrets", ["GetMemorialsFromApiDecrets","FindDataFromDecretsDocs","OpenDialogDelete"]),
    GetPressEnter(e){
      //TODO BUSCADOR
       if (e.keyCode === 13) {
         let querys = {
          ...
          this.FindDataFromDecretsDocs(querys)
    ...
    nextPage: async function() {
       ...
       if(this.isSearching == false){
        let params;
          ...
          this.GetMemorialsFromApiDecrets(params)
          .then(response =>{
